...
OUTPUT_IMAGE = "matrix_svm_no_ports.png" 
...
def main():
    ...
    X = df.drop(columns=['Label', 'Category', 'Src_Port', 'Dst_Port', 'Protocol'])
    y = df['Category']
    ...
    plt.title(f'SVM Confusion Matrix (No ports) (Accuracy: {accuracy * 100:.1f}%)', fontsize=14)
